 ...
 1500 A=INT(RND*40)-20
 1510 B=INT(RND*40)-20
 1515 E=A+B
 1520 PRINT:PRINT:PRINT"Mennyi                                          ";A;"+";B;"=";
 1530 INPUT C
 1550 IF C=E THEN PRINT:PRINT"jó megoldås!":GOSUB  2000:GOTO 40
 1560 PRINT:PRINT"Hibås, szåmold újra!":H=H+1:GOSUB 3000:GOTO 1530
 2000 FOR I=293 TO 1174 STEP 20
 2010 SOUND I,1
 2020 NEXT I
 2030 RETURN
 2500 LOCATE 10,5:PRINT"ÖSSZEADÅS, KIVONÅS EGÉSZ SZÅMOKKAL"
 2510 A$=INPUT $(1)
 2520 CLS
